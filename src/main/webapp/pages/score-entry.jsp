...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 正文区域 -->
        <form action="${pageContext.request.contextPath}/project/scoreEntry" method="post">
            <!--tab内容-->
            <div class="content">
                    ...
                    <div class="box-body">
                        <div class="center" style="margin: 0 auto;width: 40%;">
                            ...
                            <div class="row data-type">
                                ...
                                <div class="col-md-2 title">${type==true ? "团队名称":"姓名"}</div>
                                <div class="col-md-4 title">${type==true ? "团队编号":"运动员编号"}</div>
                                <div class="col-md-5 title">成绩</div>
                                <input type="hidden" name="type" value="${type}">
                                <input type="hidden" name="sort" value="${project.sort}">
                                ...
                                <c:if test="${type == true}">
                                    <c:forEach items="${teamList}" var="team" varStatus="status">
                                        ...
                                        <div class="col-md-1 title">${status.index+1}</div>
                                ...
                                <c:if test="${type == false}">
                                    <c:forEach items="${athlete}" var="athlete" varStatus="status">
                                        <input type="hidden" value="${athlete.id}" name="athleteId">
