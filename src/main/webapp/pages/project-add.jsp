...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 正文区域 -->
        <form action="${pageContext.request.contextPath}/project/save.do" method="post">
            <!--tab内容-->
            <div class="content">
                    ...
                    <div class="box-body">
                        <div class="center" style="margin: 0 auto;width: 40%;">
                            ...
                            <div class="row data-type">
                                ...
                                <div class="col-md-3 title">比赛时长</div>
                                <div class="col-md-9 data">
                                    <div class="form-group">
                                        <select class="form-control select2" style="width: 100%;" name="duration">
                                            <option selected="selected" value="0.5">0.5小时</option>
