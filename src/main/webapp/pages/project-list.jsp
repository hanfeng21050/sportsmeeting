                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc_disabled">ID</th>
                                <th>比赛名称</th>
                                <th>单位</th>
                                <th>排序</th>
                                <th>性别限制</th>
                                ...
                                <th>比赛时长</th>
                                <th>比赛类型</th>
                                <th class="sorting_asc_disabled">描述</th>
                                <th class="sorting_asc_disabled">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/orders/findById.do?id=${project.id}'">
                                            详情
                                        </button>
                                    </td>
                                </tr>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageNum}"
